...
BEGIN
  ...
  SELECT ID, NOMBRE, PRIMERAPELLIDO, SEGUNDOAPELLIDO FROM PERSONA 
  WHERE IDDISTRITO = 
  (SELECT DISTRITO.ID FROM DISTRITO, CANTON, PROVINCIA, PAIS
    WHERE PROVINCIA.IDPAIS=PAIS.ID AND CANTON.IDPROVINCIA = PROVINCIA.ID AND 
    DISTRITO.IDCANTON=CANTON.ID AND 
...
BEGIN
  ...
  SELECT ID, NOMBRE, PRIMERAPELLIDO, SEGUNDOAPELLIDO FROM PERSONA 
  WHERE IDDISTRITO = 
  (SELECT DISTRITO.ID FROM DISTRITO, CANTON, PROVINCIA
    WHERE CANTON.IDPROVINCIA = PROVINCIA.ID AND DISTRITO.IDCANTON=CANTON.ID AND 
...
BEGIN
  ...
  SELECT ID, NOMBRE, PRIMERAPELLIDO, SEGUNDOAPELLIDO FROM PERSONA 
    WHERE IDDISTRITO = 
    (SELECT DISTRITO.ID FROM DISTRITO, CANTON
      WHERE DISTRITO.IDCANTON=CANTON.ID AND CANTON.ID=CANTON_origen_ID
  );
END;
