...
public class PromoverPersona extends DialogTemplate {
	...
	public PromoverPersona(JFrame parent, String windowName, int width, int height, boolean isResizable)
		...
		this.panelContenido.setBorder(new TitledBorder(null, "Promover persona a...", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		this.txtNombreUsuario = new JDatabaseText(LibertadDatabaseConstraints.CuentaUsuario_usuario_VARCHAR2);
		...
		this.txtContrasena = new JDatabaseText(LibertadDatabaseConstraints.CuentaUsuario_contrasena_VARCHAR2);
