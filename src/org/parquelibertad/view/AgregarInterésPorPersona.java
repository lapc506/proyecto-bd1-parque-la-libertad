...
public class AgregarInterésPorPersona extends JFrame{
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AgregarInterésPorPersona window = new AgregarInterésPorPersona();
	 ...
	 */
	public AgregarInterésPorPersona() {
		setTitle("Agregar Interés");
		initialize();
	}
	...
	private void initialize() {
		...
		lblActividad.setBounds(270, 320, 167, 27);
		panel.add(lblActividad);
		
		JComboBox comboBox_4 = new JComboBox();
		comboBox_4.setBounds(167, 346, 289, 44);
		panel.add(comboBox_4);
		
		JTextArea textArea = new JTextArea();
		textArea.setBounds(167, 439, 289, 148);
		panel.add(textArea);
		
		JLabel lblHorarios = new JLabel("Horarios");
		lblHorarios.setFont(new Font("Tahoma", Font.PLAIN, 17));
		lblHorarios.setBounds(270, 401, 167, 27);
		panel.add(lblHorarios);
		
		JButton btnRegistrar = new JButton("Registrar");
		btnRegistrar.setFont(new Font("Tahoma", Font.PLAIN, 17));
		btnRegistrar.setBounds(247, 598, 126, 40);
		...
		panel_1.setBounds(10, 93, 594, 230);
		panel.add(panel_1);
