...
public class EditCiudadDialog extends DialogTemplate {
  ...
  public EditCiudadDialog(String windowName, int width, int height, boolean isVisible,
    ...
    this.ciudadPanel.setLayout(new GridLayout(0, 1, 0, 0));
    ...
    this.ciudadPanel.add(this.panel);
